...
// ====== Grupos de respuestas reutilizables ======
...
function sendMessage() {
  ...
  // Buscar coincidencias de palabras/expresiones
  ...
  // Respuesta genérica aleatoria si no hubo match
...
window.onload = () => {
  ...
  if (historial) {
    ...
    // Saludo inicial antes de cualquier validación
